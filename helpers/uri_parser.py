...
def _make_fragment_uri(g, owl_class):
    parsed_uri={}
    parsed_uri['name'] = _get_last_segment_of_uri(owl_class)
    parsed_uri['namespace'] = _get_uri_namespace(str(owl_class))
    parsed_uri['prefix'] = _get_uri_prefix(parsed_uri['namespace'], g)
    return parsed_uri
